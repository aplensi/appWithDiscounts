...
static constexpr auto qt_meta_stringdata_CLASSImageHandlerENDCLASS = QtMocHelpers::stringData(
    "ImageHandler",
    "save",
    "",
    "imageObj",
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSImageHandlerENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSImageHandlerENDCLASS_t qt_meta_stringdata_CLASSImageHandlerENDCLASS = {
    {
